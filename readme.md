...
an append-only revision snapshot for every save. Selecting an Insight highlights
its referenced Summary lines. Completing a review produces a downloadable
Markdown file containing the change log and final reviewed output.
